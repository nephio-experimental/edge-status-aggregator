...
import (
	...
	"github.com/nephio-project/edge-status-aggregator/edge/porch"
	edgewatcher "github.com/nephio-project/edge-watcher"
	"google.golang.org/grpc"
	"k8s.io/client-go/dynamic"

	deployment "github.com/nephio-project/edge-status-aggregator/deployment"
	...
	"github.com/nephio-project/edge-status-aggregator/controllers"
...
func main() {
	...
	edgeWatcherConfig.PorchClient = porch.NewClient(ctrl.Log.WithName("PorchClient"), ps, k8sRestClient)
	...
	var deploy deployment.DeploymentManager = deployment.NewDeploymentManager(
		subscriberChan, cancellationChan, mgr.GetClient(),
